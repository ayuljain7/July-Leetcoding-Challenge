...
public:
    int maxProfit(vector<int>& prices) {
        ...
        /*
        buy[i]: The max profit you can gain if you BUY stock in day i and REST for the remainder of the days.
        sell[i]: The max profit you can gain if you SELL stock in day i and REST for the remainder of the days.
        */
        
        //sell[0] is not valid so just leave it alone
        buy[0]=-prices[0];
